node {
	...
	stage('Nexus Repository'){
	    nexusArtifactUploader artifacts: [[artifactId: 'androidPOC', classifier: '', file: 'app/build/outputs/apk/release/androidPOC.apk', type: 'apk']], credentialsId: 'bcebae3d-4df0-4fb2-8ca4-6ee8af37cabb', groupId: 'com.examples.android', nexusUrl: 'localhost:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'pocAndroid', version: '18.0'
	}
	stage('App Center'){
